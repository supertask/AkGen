...
Shader "Spiralizer"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "SpiralizerVertex.hlsl"
            //#include "SpiralizerGeometry.hlsl"
            #include "SpiralizerFragment.hlsl"

            // Custom: Shader entry points
            #pragma vertex SpiralizerVertex
            //#pragma geometry SpiralizerGeometry
            #pragma fragment SpiralizerFragment
